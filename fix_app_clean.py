...
# Close the new map block properly, but ONLY the last one under "4. Properties Page"
# The string replacement replaced multiple occurrences previously.
# I'll use a safer targeted replacement.
