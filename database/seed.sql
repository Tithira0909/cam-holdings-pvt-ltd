...
-- Projects
INSERT INTO projects (id, title, category, image, description, location, year) VALUES
('p1', 'The Zenith Residence', 'Architecture', 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1200', 'A 42-story architectural marvel redefining the Colombo skyline with sustainable design.', 'Colombo 03', '2023'),
('p2', 'Nuera Gated Community', 'Urban Planning', 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=1200', 'Boutique residential enclave focused on privacy, security, and tropical modernism.', 'Battaramulla', '2022'),
('p3', 'Ocean View Condominiums', 'Construction', 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=1200', 'Premier seaside luxury living with high-durability coastal construction materials.', 'Negombo', '2021'),
('p4', 'The Heritage Pavilion', 'Restoration', 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?auto=format&fit=crop&q=80&w=1200', 'Sensitive restoration of a colonial-era manor into a modern boutique luxury hotel.', 'Kandy', '2020');
