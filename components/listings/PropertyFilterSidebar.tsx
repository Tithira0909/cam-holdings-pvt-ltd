    ...
    <div className="bg-white rounded-[20px] shadow-[0px_4px_30px_rgba(0,0,0,0.04)] border border-gray-100/50 p-6 md:p-8 lg:sticky lg:top-32 xl:top-36">
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
         ...
         <button
           ...
           className="text-xs font-bold uppercase tracking-wider text-gray-400 hover:text-red-600 transition-colors flex items-center gap-1.5"
         >
           <RotateCcw size={14} />
           Reset
         </button>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2.5">
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-red-600/60">
               <Building size={16} />
            </div>
            <select
              value={filters.category}
              onChange={(e) => setFilters(prev => ({ ...prev, category: e.target.value }))}
              className="w-full pl-11 pr-10 py-3.5 bg-gray-50 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-red-600/30 focus:bg-white transition-all cursor-pointer"
            >
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-red-600/30 focus:bg-white transition-all"
            />
        ...
        <div className="space-y-2.5 pt-4 border-t border-gray-100">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-red-600/30 focus:bg-white transition-all"
            />
          </div>
        </div>
