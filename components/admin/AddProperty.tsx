        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="pt-8 border-t border-gray-100">
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-dashed border-gray-300 text-center">
              <p className="text-luxury-gray italic mb-2">Gallery images can be added after the property is created.</p>
              <p className="text-sm text-luxury-gray">Save this property first, then edit it to upload gallery images.</p>
            </div>
          </div>
          </div>
